<div class="max-w-7xl mx-auto py-12 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
            <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Support Tickets</h2>
            <p class="mt-2 text-sm text-gray-500">Track and manage your requests with our support team.</p>
        </div>
        <div class="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            <div class="relative group w-full sm:w-64">
                ...
                <input type="text" wire:model.live.debounce.500ms="search" class="pl-10 w-full rounded-xl border-gray-200 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition-all duration-200 bg-white" placeholder="Search your tickets...">
            </div>
    ...
    <div wire:loading.remove>
            ...
            <div class="grid gap-6 sm:grid-cols-1 lg:grid-cols-2">
                @foreach($tickets as $ticket)
                    <a href="{{ route('tickets.show', $ticket) }}" wire:navigate class="block group">
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-lg hover:border-indigo-100 transition-all duration-300 transform group-hover:-translate-y-1 relative overflow-hidden">
                            ...
                            <div class="relative z-10">
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center space-x-3">
                                        <span class="inline-flex items-center justify-center h-10 w-10 rounded-xl bg-indigo-50 text-indigo-600 font-semibold text-sm">
                                            #{{ $ticket->id }}
                                        </span>
                                        @php
                                ...
                                <h3 class="text-lg font-bold text-gray-900 group-hover:text-indigo-600 transition-colors duration-200 mb-2 truncate">
                                    {{ $ticket->subject }}
                                </h3>
        ...
        @else
            <div class="text-center bg-white shadow-sm border border-gray-100 rounded-3xl p-16">
                ...
                <h3 class="mt-2 text-xl font-bold text-gray-900">No tickets found</h3>
                <p class="mt-2 text-base text-gray-500 max-w-sm mx-auto">You haven't created any support tickets yet, or none match your search criteria.</p>
                <div class="mt-8">
                    <a href="{{ route('tickets.create') }}" wire:navigate class="inline-flex items-center px-6 py-3 border border-transparent shadow-sm text-base font-medium rounded-xl text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200">
